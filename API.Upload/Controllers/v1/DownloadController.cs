    ...
    public class DownloadController : BaseController<DoanhNghiep, IDoanhNghiepBusiness>
    {
        ...
        public async Task<JsonResult> ReportCA203_204_206_207ToHTMLAsync()
        {
            ...
            try
            {
                ...
                {
                    result = GlobalHelper.APISuccessMessage;
                ...
                {
                    result = GlobalHelper.APIErrorMessage;
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<JsonResult> ReportCA503_504_506_507ToHTMLAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    int year = baseParameter.Year.Value;
                    int month = baseParameter.Month.Value;
                    bool isSmartCA = baseParameter.IsSmartCA.Value;
        ...
        public async Task<JsonResult> ReportVNPT001ToExcelAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    ...
                    long xaID = baseParameter.XaID.Value;
                    string searchString = baseParameter.SearchString;
                    int year = baseParameter.Year.Value;
                    int month = baseParameter.Month.Value;
        ...
        public async Task<JsonResult> ReportVNPT003ToExcelAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    ...
                    long xaID = baseParameter.XaID.Value;
                    string searchString = baseParameter.SearchString;
                    long dichVuID = baseParameter.DichVuID.Value;
                    int year = baseParameter.Year.Value;
                    int month = baseParameter.Month.Value;
        ...
        public async Task<JsonResult> ReportVNPT005ToExcelAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    long nhanVienID = baseParameter.NhanVienID.Value;
                    int year = baseParameter.Year.Value;
        ...
        public async Task<JsonResult> ReportCA105ToExcelAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    ...
                    int month = baseParameter.Month.Value;
                    long nhanVienID = baseParameter.NhanVienID.Value;
                    int hetHan = baseParameter.HetHan.Value;
        ...
        public async Task<JsonResult> ReportCA108ToExcelAsync()
        {
            ...
            try
            {
                ...
                if (baseParameter.Token == GlobalHelper.Token)
                {
                    ...
                    int month = baseParameter.Month.Value;
                    long nhanVienID = baseParameter.NhanVienID.Value;
                    bool isKetLuan = baseParameter.IsKetLuan.Value;
