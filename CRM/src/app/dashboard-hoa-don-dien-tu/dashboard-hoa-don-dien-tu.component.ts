...
@Component({
  selector: 'app-dashboard-hoa-don-dien-tu',
  templateUrl: './dashboard-hoa-don-dien-tu.component.html',
  styleUrls: ['./dashboard-hoa-don-dien-tu.component.css']
})
export class DashboardHoaDonDienTuComponent implements OnInit {
  ...
  huyenID: number = 1;
  xaID: number = 1;
  dichVuID: number = environment.HoaDonDienTuID;
  phongBanID: number = 1;
  nhanVienID: number = 1;
